...
Mini-project title: Hello-world function

Submission date: Feb 12
...
I used frequent and informative comments in my code and markdown. I used the comments to explain the purpose of the code and the logic behind the code. I also used comments to explain the output of the code.
I found and understood documentation for R packages and functions. I used the help function to find the documentation for the functions I used in my code. I read the documentation to understand the arguments of the functions and how to use them.
I parsed and wrote 'for' and 'while' loops. I used 'for' loops to iterate over a sequence of numbers and 'while' loops to iterate until a condition is met.
...
It took me a while to refamiliarize myself with all of the functions and coding style. I think the most challenging thing is to understand the examples first and then apply them to my own code. I figured out the logics of the functions using documentation pages for R functions, which was really helpful. It's also challenging to develop a creative function that are different than the provided example because I tended to imitate the example rather then adding something creative. 
