---
title: "Assignment: Recreate this dataset (Level 2) - INSTRUCTOR KEY"
---

# Objective

This advanced data transformation assignment challenges you to practice **complex data wrangling** techniques using the tidyverse ecosystem. You will work with the `gapminder` dataset, applying sophisticated data manipulation skills with minimal guidance.
...
You may additionally or alternatively complete the [Level 1 recreation assignment](), which uses a simpler goal dataframe and provides more detailed instructions.
...
#gm.wrangled.goal <- read_csv("assessment/recreate-level-2/gm-wrangled-goal.csv")
...
Edit the `assessment.md` file in this repo to indicate which course objectives you believe you have met.

To submit, commit and push your work to GitHub classroom.
